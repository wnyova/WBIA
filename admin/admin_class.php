...
Class Action {
    ...
    {
        // Implement your database query here to fetch user details based on the provided email
        // Make sure to handle password securely (e.g., use password_hash() and password_verify())

        // Example: Fetch user details from the 'users' table
        $query = "SELECT id, firstname, lastname, email, type FROM users WHERE email = '$email'";
        $result = // Execute your database query here
